...
WebUI.click(findTestObject('Page_CURA Healthcare Service/btn_Appointment1'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Page_CURA Healthcare Service/Login'))
